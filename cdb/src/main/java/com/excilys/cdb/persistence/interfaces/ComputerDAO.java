...
public interface ComputerDAO {
    ...
    List<Computer> getComputers() throws DBException, CorruptComputersException;

    List<Computer> getComputers(String search) throws DBException;
     ...
     */
    void createComputer(Computer c) throws DBException;
     ...
     * @throws DBException if something goes wrong with the database
     */
    boolean updateComputer(Computer c) throws DBException;

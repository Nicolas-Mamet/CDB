...
import com.excilys.cdb.crossProject.Order.OrderBy;
...
@Controller
public class PrepareDashboardController {
...
//    }
    ...
    private long getNbComputers(ComputerService serviceComputer)
            throws DBException {
        return serviceComputer.countComputers();
    }

    private Optional<PageManager> buildPageManager(
            String offset,
            String limit,
            long nbComputers) {
        try {
    ...
    private ModelAndView prepareAndForward(
            String offset,
            String limit,
            String search,
...
//        limit = verifLimit(limit);
        ...
        ModelAndView modelAndView =
                ControllerCommonFunction.forward(Address.DASHBOARD);
    ...
    private long getNbComputers(ComputerService serviceComputer, String search)
            throws DBException {
